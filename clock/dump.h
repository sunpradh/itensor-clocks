...
void
dump_single_row(ostream & os, const pair<uint, Tx> & x, const umap<Tx, Ty> & y)
{
...
template <typename Tx, typename Ty>
void
dump_single_row(ostream & os, const pair<uint, Tx> & x, const vector<Ty> & y)
{
...
void
dump_single_row(ostream & os, const pair<uint, Tx> & x, const Generic & y, Args ... args)
{
